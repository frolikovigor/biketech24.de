...
{if $bestellschritt[3] == 1} {redirect("bestellvorgang.php?editLieferadresse=1")} {/if}

<div class="steps-circle">

    <div class="line"></div>

    <div class="s-circle {if $bestellschritt[1] == 3 }s-circle_active{/if} {if $bestellschritt[1] == 2 }s-circle_done{/if}">
        <div class="num">
            <span>1</span>
        </div>
        <div class="check">
    ...
    <div class="s-circle {if $bestellschritt[2] == 1 }s-circle_active{/if} {if $bestellschritt[2] == 2 }s-circle_done{/if}">
        <div class="num">
            <span>2</span>
        </div>
    ...
    <div class="s-circle {if $bestellschritt[4] == 1}s-circle_active{/if} {if $bestellschritt[4] == 2 }s-circle_done{/if}">
        <div class="num">
            <span>3</span>
        </div>
        {if $bestellschritt[4] == 2 }<a href="bestellvorgang.php?editZahlungsart=1">{/if}
            <div class="check">
                <i class="icons icons_white-check"></i>
            </div>
            <div class="name">
