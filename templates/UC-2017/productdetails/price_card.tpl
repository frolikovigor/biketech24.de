        ...
        {else}
            ...
            {else}
                ...
                {if $Artikel->fUVP>$Artikel->Preise->fVKBrutto || $Artikel->Preise->Sonderpreis_aktiv}
                    ...
                    <div class="ipi-price">
                        <span class="ipi-price_red">{$Artikel->Preise->cVKLocalized[$NettoPreise]}</span>
                        <span class="ipi-price_strike">
                ...
                {else}
                    <div class="ipi-price">
                        <span class="ipi-price">{$Artikel->Preise->cVKLocalized[$NettoPreise]}</span>
