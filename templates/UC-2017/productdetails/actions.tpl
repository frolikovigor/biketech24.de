<div id="product-actions" class="btn-group btn-group-sm product-actions" role="group">
	...
	{if $Einstellungen.global.global_wunschliste_anzeigen === 'Y'}
		<button name="Wunschliste" type="submit" class="item-product-like btn btn-default btn-secondary wishlist" title="{lang key="addToWishlist" section="productDetails"}">
			{*<span class="fa fa-heart"></span>*}
			{*<span class="hidden-sm">{lang key="wishlist" section="global"}</span>*}
			<img src="/dev/static/img/content/item-like.png">
		</button>
